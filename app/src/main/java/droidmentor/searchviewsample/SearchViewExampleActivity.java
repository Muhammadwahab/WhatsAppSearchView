...
//        searchView.setSubmitButtonEnabled(false);
        ...
        // @enable these line to enable search button
...
//
        ...
        searchButton.setColorFilter(Color.parseColor("#065E52"));
        ...
        closeButton.setColorFilter(Color.parseColor("#065E52"));

        // set hint and the text colors

        EditText txtSearch = ((EditText) searchView.findViewById(android.support.v7.appcompat.R.id.search_src_text));
        txtSearch.setHint("Search");
        txtSearch.setHintTextColor(getResources().getColor(R.color.colorPrimary));
